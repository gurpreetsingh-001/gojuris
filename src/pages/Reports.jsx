...
const Reports = () => {
  ...
  const stateCodeMap = [
    { key: "Law Commission", value: "LCRF" },
    { key: "Constituent Assembly Debates", value: "DAC" },
  ...
  const loadJudgements = async (courtKey) => {
    ...
    const apiResponse = await LeApiService.getReportList(courtKey);
        ...
        <div className="database-container">
          ...
          <div className="content-wrapper robotofont">
            ...
            <div className="courts-sidebar">
              <div className="courts-header">Select Report</div>
